...
import test.opengl.ObjLoader.BuilderInterface;
...
public class Parse {
    ...
    public Parse(Context context, BuilderInterface builder, int ressourceId) throws FileNotFoundException, IOException {
        ...
        builder.setObjFilename("");
        parseObjFile(ressourceId);

        builder.doneParsingObj("");
    }

    private void parseObjFile(int res) throws FileNotFoundException, IOException {
        int lineCount = 0;
        FileReader fileReader = null;
        BufferedReader bufferedReader = null;
        InputStream inputStream = m_context.getResources().openRawResource(res);
