...
public class Quaternion {
    ...
    public void setRotation(Vector3 v, float angle){
        ...
        float s = (float)Math.min(Math.sin(half), 1);
        x = v.x*s;
        y = v.y*s;
        z = v.z*s;
        w = (float)Math.min(Math.cos(half),1);
    }
    ...
    public String toString(){
        return String.valueOf(w) + "," + String.valueOf(x) +  "," + String.valueOf(x) +  "," + String.valueOf(y) +  "," + String.valueOf(z);
    }
}
